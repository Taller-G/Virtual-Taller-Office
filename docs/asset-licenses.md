...
| `avatars/layers/{base}/cap.png` `beanie.png`          | Hat accessories, one sheet per silhouette (32x48 sheets, 52 frames, transparent overlay); original pixel art generated with `tools/gen-accessories.py`                                                                 | Taller                 | Own                                       | —         |
| `avatars/layers/{base}/glasses-*.png`                 | Glasses accessories, one sheet per silhouette (32x48 sheets, 52 frames, transparent overlay); original pixel art generated with `tools/gen-accessories.py`                                                             | Taller                 | Own                                       | —         |
