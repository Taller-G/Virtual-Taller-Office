...
| `tilesets/ChironDark.png`                             | Pisos, paredes y luces de la Chiron Office (hoja 8×5, 32×32): tiles de `FloorAndGround` pasados por un duotono frío, más charcos de luz, tira LED y vano de puerta dibujados a mano; generado con `tools/make-chiron-tileset.py` | LimeZu (edición: Taller) | LimeZu Modern Interiors (edición permitida) | —         |
...
| `map/chiron-office.json`                              | Plano de la Chiron Office (mapa Tiled), generado con `tools/make-chiron-map.py`                                                                                                                                                  | Taller                   | Propio                                      | —         |
